...
"""
        ...
        # Allow all for canonical domain; Content-Signal + AI/bot disallows per Cloudflare Managed
        robots_content = """# As a condition of accessing this website, you agree to abide by the following
# content signals:
#
